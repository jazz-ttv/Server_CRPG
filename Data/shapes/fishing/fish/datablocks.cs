...
function FishDatablocks(%name,%shapeName,%stackMax)
{
	...
	%shape = expandFileName("./data/shapes/fishing/fish/resources/" @ %shapeName @ "/" @ %shapeName @ ".dts");
	...
	for(%i = 0; %i < %count; %i++)
	{
		...
		%shape = expandFileName("./data/shapes/fishing/fish/resources/" @ %shapeName @ "/" @ %shapeName @ (%i + 1) @ ".dts");
